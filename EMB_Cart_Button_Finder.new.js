// Brightspeed Cart Button Finder
// This script will find the cart button and add a click event listener to it
...
(function () {
  ...
  function initializeMainScript(parsedMapiData = null, eventRequestId = null) {
    ...
    // CSV data containing promo code to sales code mapping
...
172537,8009766`;
    ...
    // Define the promo code to sales code mapping from CSV data
    const promoToSalesCodeMap = buildPromoMap(csvMappingData);
    ...
    try {
      ...
      let buyflowUrl = `https://px-test-ordering.lumen.com/index?salescode=${salescode}&brnd=c&partnerId=clearlink${
